          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            showPlayingLoader == true
                ...
                : IconButton(
                    ...
                    icon: Icon(
                      ...
                      size: 40,
                      color: !widget.isMe! ? Colors.white: primaryColors.withOpacity(0.9),
                    ),
                  ),
            SizedBox(
              width: 2,
            ...
            IconButton(
              ...
              icon: Icon(
                ...
                size: 40,
                color: !widget.isMe! ? Colors.white: primaryColors.withOpacity(0.7)
                // getPauseResumeFn1() == null
                //     ? widget.isMe!
                      ...
                      children: [
                        ...
                        Positioned(
                            ...
                            child: Icon(
                              Icons.download,
                              size: 16,
                              color:!widget.isMe! ? Colors.white: primaryColors,
                            ))
                      ],
                    ),
                  )
