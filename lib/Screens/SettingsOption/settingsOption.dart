...
import 'package:fiberchat/Screens/privacypolicy&TnC/newpdfView.dart';
import 'package:fiberchat/Screens/wallet/wallet.dart';
    ...
    return PickupLayout(
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            leading: Padding(
              ...
              child: Icon(
                ...
                color: primaryColors.withOpacity(0.75),
                size: 26,
              ),
            ),
            title: Text(
          ...
          ListTile(
            onTap: () {
              launch('mailto:support@messpe.com');
            },
            contentPadding: EdgeInsets.fromLTRB(30, 3, 10, 3),
            leading: Padding(
              padding: const EdgeInsets.only(top: 6),
              ...
              //   } else if (observer.tncType == 'file') {
                  Navigator.push(
                    ...
                    MaterialPageRoute<dynamic>(
                      builder: (_) => NewPDFViewerCachedFromUrl(
                        title: getTranslated(context, 'tnc'),
                        url: 'assets/privacyPolicy/TERMS_OF_SERVICES.pdf',
                        isregistered: true,
                      ),
                    ),
                  );
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute<dynamic>(
                      builder: (_) => NewPDFViewerCachedFromUrl(
                        ...
                        url: 'assets/privacyPolicy/MessPe_Privacy_Policy.pdf',
                        isregistered: true,
                      ),
                    ),
                  );
          ...
          ListTile(
            onTap: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute<dynamic>(
                  builder: (_) => NewPDFViewerCachedFromUrl(
                    title: getTranslated(context, 'pp'),
                    url: 'assets/privacyPolicy/Return_Policy.pdf',
                    isregistered: true,
                  ),
                ),
              );
            ...
            subtitle: Padding(
              padding: const EdgeInsets.only(top: 4),
              child: Text('Return Policy for our app',
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: TextStyle(
                    fontSize: 14, color: fiberchatBlack.withOpacity(0.56)),
