...
import 'package:fiberchat/Screens/auth_screens/welcome_screen.dart';
        ...
        : accountstatus != null
            ...
            : ConnectWithAdminApp == true && maintainanceMessage != null
                ...
                : ConnectWithAdminApp == true && isFetching == true
                    ? !widget.prefs.getBool('isFirstTime')!
                        ? Splashscreen()
                        : Scaffold(
                    ...
                    : PickupLayout(
                        ...
                        child: Scaffold(
                                                              ...
                                                              unawaited(Navigator.push(
                                                                  ...
                                                                  MaterialPageRoute(
                                                                      builder: (context) => Security(
                                                                            ...
                                                                            title:
                                                                                getTranslated(this.context, 'authh'),
                                                                          ))));
                                                            } else {
                                      ...
                                      case 'group':
                                        if (observer.isAllowCreatingGroups ==
                                          ...
                                          final AvailableContactsProvider
                                              dbcontactsProvider = Provider.of<
                            ...
                            //           children: [
                            //             Icon(Icons.message , color: primaryColors,size: 25,),
                            //             SizedBox(width: 5,),
                            //             Text('Chats', style: TextStyle(fontSize: 18, color: primaryColors, fontWeight: FontWeight.w400),),
                            //           ],
                            //         ),
                            //
                            //
                            ...
                            //         mainAxisAlignment: MainAxisAlignment.center,
                            //         children: [
                            //           Icon(CupertinoIcons.smiley , color: primaryColors,size: 25,),
                            //           SizedBox(width: 5,),
                            //           Text('Stories', style: TextStyle(fontSize: 18, color: primaryColors, fontWeight: FontWeight.w400),),
                            //         ],
                            //       ),
                            //       Row(
                            //         mainAxisAlignment: MainAxisAlignment.center,
                            //         children: [
                            //           Icon(Icons.call , color: primaryColors,size: 25,),
                            //           SizedBox(width: 5,),
                            //           Text('Calls', style: TextStyle(fontSize: 18, color: primaryColors, fontWeight: FontWeight.w400),),
                            //         ],
                            //       ),
                            //       // Tab(
                            //       //   child: Text(
                            ...
                            //         mainAxisAlignment: MainAxisAlignment.center,
                            //         children: [
                            //           Icon(Icons.message , color: primaryColors,),
                            //           SizedBox(width: 5,),
                            //           Text(getTranslated(context, 'chats'), style: TextStyle(color: primaryColors),),
                            //         ],
                            //       ),
                            //       Row(
                            //         mainAxisAlignment: MainAxisAlignment.center,
