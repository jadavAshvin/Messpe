              ...
              child: Column(
                children: [
                  ListTile(
                      ...
                      leading:
                          customClipRRectGroup(url: user['photoUrl'], radius: 10),
                      subtitle: Text('Hey , there today is meeting ', style: TextStyle(color: Colors.black),),
                      title: Text(
                      ...
                      trailing: unread != 0
                          ...
                          : user[Dbkeys.lastSeen] == true
                              ? Column(
                        children: [
                          Text("09:00 AM",style: TextStyle(color: Colors.grey.shade600)),
                          Container(
                            child: Text(unread.toString(),
                                style: TextStyle(
                                    fontSize: 14,
