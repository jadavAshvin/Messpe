...
//       //----sharing intent action:
        ...
        ? doc[Dbkeys.isReply] == true
            ? Column(
                ...
                children: [
                  ...
                  selectablelinkify(doc[Dbkeys.content], 15.5, TextAlign.left, isMe),
                ],
              )
            : doc.containsKey(Dbkeys.isForward) == true
                ? doc[Dbkeys.isForward] == true
                    ? Column(
                        ...
                        children: [
                          ...
                          selectablelinkify(
                              doc[Dbkeys.content], 15.5, TextAlign.left, isMe)
                        ],
                      )
                    : selectablelinkify(
                        doc[Dbkeys.content], 15.5, TextAlign.left, isMe)
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                      ...
                                      child: customClipRRectGroup(url: groupList
                                                .lastWhere((element) =>
                                                    element
                                                        .docmap[Dbkeys.groupID] ==
                                                    widget.groupID)
                                                .docmap[Dbkeys.groupPHOTOURL],radius: 10, height: 50, width: 50 )
  ...
  Widget selectablelinkify(
      String? text, double? fontsize, TextAlign? textalign, isMe) {
