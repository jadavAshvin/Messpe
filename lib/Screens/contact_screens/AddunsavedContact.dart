  ...
  //           margin: EdgeInsets.symmetric(horizontal: 65),
        ...
        Padding(
          ...
          child: isLoading == true
              ...
              : MySimpleButton(
                  buttoncolor: primaryColors.withOpacity(0.99),
...
class NewMobileInputWithOutline extends StatefulWidget {
  ...
  NewMobileInputWithOutline(
      {this.height,
        ...
        this.buttonText});
  @override
  _NewMobileInputWithOutlineState createState() => _NewMobileInputWithOutlineState();
}

class _NewMobileInputWithOutlineState extends State<NewMobileInputWithOutline> {
  BoxDecoration boxDecoration(
    ...
    return BoxDecoration(
        ...
        boxShadow: showShadow
            ? [
          BoxShadow(
              color: primaryColors, blurRadius: 10, spreadRadius: 2)
        ]
