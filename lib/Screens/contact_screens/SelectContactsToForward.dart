...
class _SelectContactsToForwardState extends State<SelectContactsToForward>
  ...
  fetchJoinedGroups() async {
    ...
    print('called fetchJoinedGroups');
    print('called ${Dbkeys.groupMEMBERSLIST}');

    print('called ${widget.currentUserNo}');
    print('called ${Dbkeys.groupCREATEDON}');
    print('called ${Dbkeys.groupMEMBERSLIST}');
    ...
    await FirebaseFirestore.instance
      ...
      if (groupsList.docs.length > 0) {
        ...
        print('called fetchJoinedGroups if');
        ...
        print('called fetchJoinedGroups else');
        isGroupsloading = false;
        setState(() {});
      }
    });
    ...
    return Stack(children: [
      Container(
        child: Center(
          ...
          valueColor: AlwaysStoppedAnimation<Color>(primaryColors),
        )),
      )
    ]);
  }
