...
import 'generateReferralCode.dart';

class LoginScreen extends StatefulWidget {
  LoginScreen(this.phoneCode, this._phoneNo, this.referralPhoneNumber,
      this.referralCode,
      {Key? key,
      this.title,
...
class LoginScreenState extends State<LoginScreen>
  ...
  // final _referralNumber = TextEditingController();
  String? phoneCode = DEFAULT_COUNTTRYCODE_NUMBER;
  final storage = new FlutterSecureStorage();
  DeviceInfoPlugin deviceInfo = DeviceInfoPlugin();
  Timer? timer;
  int _currentStep = 0;
  ValueNotifier<int> counter = ValueNotifier<int>(30);
  ...
  Future<void> verifyPhoneNumber() async {
    ...
    await firebaseAuth.verifyPhoneNumber(
        phoneNumber: (phoneCode! + _phoneNo!).trim(),
  ...
  Future<Null> handleSignIn({AuthCredential? authCredential}) async {
    ...
    // print("Auth Credential" + authCredential!.providerId.toString());
    var phoneNo = (phoneCode! + _phoneNo!).trim();
    ...
    if (firebaseUser != null) {
      ...
      if (documents.isEmpty) {
        String generatedReferralCode =
            GenerateReferralCode.generateReferralCode(_name.text, phoneNo);
        await storage.write(
            key: Dbkeys.privateKey, value: pair.secretKey.toBase64());
        print("Called " + widget.referralPhoneNumber);
        if (widget.referralPhoneNumber.isNotEmpty) {
          String docId = DateTime.now().millisecondsSinceEpoch.toString();
          FirebaseFirestore.instance
              .collection(DbPaths.collectionusers)
              .doc(widget.referralPhoneNumber)
              .collection('wallet')
              .doc(docId)
              .set({
                'id': docId,
        ...
        print('data '+widget.referralPhoneNumber);
        print('data '+widget._phoneNo);
        print('data '+widget.referralCode);
        // print('data '+widget.);
        ...
        await FirebaseFirestore.instance
          ...
          Dbkeys.credits: 0,
          Dbkeys.referralCode: generatedReferralCode,
          // Dbkeys.referralNumber: _referralNumber.text.trim(),
          Dbkeys.photoUrl: firebaseUser.user!.photoURL ?? '',
          Dbkeys.id: firebaseUser.user!.uid,
          Dbkeys.phone: phoneNo,
          Dbkeys.phoneRaw: _phoneNo,
          ...
          Dbkeys.phonenumbervariants: phoneNumberVariantsList(
              countrycode: phoneCode, phonenumber: _phoneNo)
        ...
        //  String credits = '0';
        //  documents.forEach((element) {  credits =  element['credits'];});
        // Fiberchat.toast('Your referral number not applied because your number is already registered  ');
        await storage.write(
                          ...
                          Container(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                //       LengthLimitingTextInputFormatter(25),
                                //     ],
                                //     controller: _referralNumber,
                                //     leftrightmargin: 0,
                                //     showIconboundary: false,
                                //     boxcornerradius: 5.5,
                                //     boxheight: 50,
                                //     hinttext: 'Enter referral number',
                                //     prefixIconbutton: FaIcon(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              "We have send you the confirmation code on the number you provide",
                              maxLines: 2,
                              style: TextStyle(
                                  color: Colors.grey.shade500,
                                  wordSpacing: 2,
                                      ...
                                      return Column(
                                        ...
                                        children: [
                                          timer != null && timer!.isActive
                                              ? Text(
                                                  "Resend code in 0:${counter.value} sec",
                                                  style: TextStyle(
                                                      color:
