...
class ChatScreen extends StatefulWidget {
  GlobalKey<_ChatScreenState> _myKey = GlobalKey();
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  Widget selectablelinkify(String? text, double? fontsize, bool isMe) {
    return SelectableLinkify(
      style: TextStyle(
          fontSize: fontsize, color: !isMe ? Colors.white : Colors.black),
      text: text ?? "",
      onOpen: (link) async {
        if (1 == 1) {
        ...
        children: [
          isReplyKeyboard == true
            ...
            context,
              ...
              : SizedBox(),
          Container(
            margin: EdgeInsets.only(bottom: Platform.isIOS == true ? 20 : 10),
            child: Row(
              children: <Widget>[
                Flexible(
                  child: Container(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(bottomLeft: Radius
                                  .circular(25), bottomRight: Radius.circular(
            ...
            child: SizedBox(
              ...
              child: EmojiPicker(
                  ...
                  config: Config(
                      ...
                      iconColorSelected: primaryColors,
                      progressIndicatorColor: Colors.blue,
                      backspaceColor: primaryColors,
                      showRecentsTab: true,
                      recentsLimit: 28,
                                  ...
                                  children: [
                                    Padding(
                                        padding: const EdgeInsets.fromLTRB(
                                            0, 12, 0, 12),
                                        child:
//                                             Fiberchat.ClipRRectavatar(peer, radius: 10),

                                        customClipRRectGroup(
                                            url: peer!['photoUrl'],
                                            radius: 10,
                                            height: 50,
                                            width: 50)
