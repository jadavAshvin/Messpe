...
class FlutterPainterExample extends StatefulWidget {
  ...
  const FlutterPainterExample({Key? key, this.file}) : super(key: key);
...
class _FlutterPainterExampleState extends State<FlutterPainterExample> {
  ...
  void renderAndDisplayImage() async {
    ...
    path = pathTemp.path +
        ...
        '.png';
    final _imageFile = await File(path)
        .writeAsBytes(List.from(await imageFuture as Uint8List));
    print('Called' + _imageFile.path);
